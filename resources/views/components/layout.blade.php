...
<head>
    ...
    <!-- font awesome css -->
    <link rel="stylesheet" href="{{ asset('template/path/to/font-awesome/css/font-awesome.min.css')}}">

    <!-- Tambahkan ini di dalam layout atau di bagian head -->
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/resources/views/about.blade.php">About</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/resources/views/project.blade.php">Portfolio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/resources/views/certificate.blade.php">Service</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/resources/views/skill.blade.php">Blog</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/resources/views/contact.blade.php">Contact Us</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p class="blog_text">upidatat non proident, sunt in culpa qui officia deserunt mollit anim id
                        est
                        laborum."</p>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="blog_box">
                            <div class="blog_box_3">
                                ...
                                <p class="lorem_text">elit, sed do eiusmod tempor incididunt ut labore et dolore
                                    magna
                                    aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris</p>
                            </div>
                        </div>
